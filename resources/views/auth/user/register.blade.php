...
@section('content')
    <div class="card-body">
        <div class="border p-4 rounded">
            ...
            <div class="form-body">
                <form class="row g-3" action="{{ route('users.register_user') }}" method="POST">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group" id="show_hide_password">
                            <input type="password" class="form-control border-end-0" id="password"
                                name="password" value="12345678" placeholder="Enter Password"  required>
                            <a href="javascript:;" class="input-group-text bg-transparent"
                                value="{{ old('password') }}"><i class='bx bx-hide'></i></a>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <select class="form-select" id id="country" name="country"  required>
                            @foreach (countries() as $country)
                                <option value="{{ $country['iso_3166_1_alpha2'] }}" @selected(old('iso_3166_1_alpha2') === $country['iso_3166_1_alpha2'])>{{ $country['name'] }}</option>
                            @endforeach
